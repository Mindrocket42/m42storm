...
def main(args):
    ...
    # The --retriever argument might need adjustment if other RM types (e.g., VectorRM) are supported elsewhere.
    # For now, assume 'openai' is the intended choice for online search.
